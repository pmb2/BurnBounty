...
type PlayClientPageProps = {
  initialStep?: string | null;
};

export default function PlayClientPage({ initialStep }: PlayClientPageProps) {
  ...
  useEffect(() => {
    ...
    if (initialStep === 'reveal' && parsedStash) {
      setStep('reveal');
      return;
    }

    if (initialStep === 'commit') {
      setStep('commit');
      return;
    }
